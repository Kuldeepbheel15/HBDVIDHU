...
export default function FourthScreen({ onShowOverlay }) {
  ...
  const specialMessage = `Dearest Vaidehi,

Every day with you feels like a beautiful dream that I never want to wake up from. You've brought so much joy, laughter, and love.
...
Again, Happiest birthday Vaidehi 🎈🎉 Wishing you the best birthday ever 🥳🍫🍰🎂, कलयुग के राजा, अष्ट सिद्धि नौ निधि के दाता, सूर्य देव शिष्य, अंजनी पुत्र, पवन पुत्र, पंचमुखी बाला जी महाराज, राम भक्त हनुमान bless you long, happy and healthy life. Be happy always and keep smiling forever..`
